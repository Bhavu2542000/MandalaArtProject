...
# Main function
def main():
    print(LINE1 + "\nWelcome to Mandala ART Generator\n" + LINE1)
    while True:
    ...
    print(f"In this Mandala Art Generator, you get to choose the size and colors of your mandala, or have the computer generate a random one, {name}.\n{LINE2}")
    time.sleep(1)
